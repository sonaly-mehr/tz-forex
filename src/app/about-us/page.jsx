...
const page = () => {
  return (
    <div className="relative">
      ...
      >
        {/* hero */}
        <div className="md:w-[90%] lg:w-[60%] xl:w-[48%] mx-auto pt-6 lg:pt-24 px-4 md:px-0">
          <h2 className="font-aeonik-pro text-white leading-[120%] text-left text-[40px] md:text-[50px] lg:text-[55px] xl:text-[64px] md:text-center">
      ...
      <div className="border border-[#E9E9E9] -mt-20 lg:mt-0 relative z-10 w-[90%] mx-auto py-4 lg:py-10 px-4 lg:px-8 flex flex-col lg:flex-row gap-4 lg:gap-0 justify-between container rounded-2xl  mb-10 lg:mb-20 shadow-[0px_6px_20px_0px_#0000000A]">
        <h5 className="font-openSans font-semibold text-xl lg:text-2xl text-primary lg:ml-[10px] xl:w-[38%]">
          Like you, we've been frustrated by:
        </h5>
        <ul className="flex flex-col gap-3 lg:gap-2  ">
          <li className="font-openSans font-normal text-black text-base flex gap-1.5 items-center">
            <RxCross2 className="text-lg text-[#CC0000] flex-shrink-0 " /> High
            transfer fees that eat into hard-earned money
          </li>
          <li className="font-openSans font-normal text-black text-base flex gap-1.5 items-center">
            <RxCross2 className="text-lg text-[#CC0000] flex-shrink-0" /> Banks
            & providers that offer terrible exchange rates
          </li>
          <li className="font-openSans font-normal text-black text-base flex gap-1.5 items-center">
            <RxCross2 className="text-lg text-[#CC0000] flex-shrink-0" /> Slow
            and complicated processes
          </li>
        </ul>
        <div className="flex items-center  lg:justify-end ">
          <h6 className="font-matter-medium text-black text-lg lg:w-[60%] mt-3 lg:mt-0">
      ...
      {/* why-choose-remiflow */}
      <div className="py-6 lg:py-12 px-4 lg:px-8 flex gap-10 justify-between md:w-[90%] lg:w-[80%] mx-auto items-center">
        <div className="hidden lg:block">
          <Image src={whyRemiflow} alt="" className="" />
        </div>

        <div className="">
          <h2 className="heading  lg:text-[48px] !mb-6 lg:!mb-[60px]">
            Why Choose Remiflow?
          </h2>
            ...
            {whyChooseRemiflow?.map((item, index) => (
              <div key={index} className="flex gap-5 items-center">
                ...
                <div>
                  ...
                  <p className="font-openSans font-normal text-[#1A1A1A] tex-sm lg:text-lg ">
                    {item?.descp}
                  </p>
                </div>
              </div>
      ...
      {/*Our Goal */}
      <div className="border border-[#E9E9E9] py-5 lg:py-10 px-4 lg:px-16 flex flex-col gap-2 lg:gap-0 lg:flex-row justify-between w-[90%] lg:w-[80%] mx-auto rounded-2xl mt-4 mb-10 lg:mb-20 shadow-[0px_6px_20px_0px_#0000000A]">
        <h5 className="font-openSans font-semibold mb-2.5 lg:mb-0 text-lg  lg:text-2xl text-primary lg:ml-[10px] lg:w-[45%]">
          Unlike big corporations, we don’t take massive commissions. Our goal
          is simple:
        </h5>
        <ul className="flex flex-col gap-4 lg:gap-2  ">
          <li className="font-openSans font-normal text-black text-base flex gap-1.5 items-center">
            <GiCheckMark className="text-lg text-[#5CB85C]" />
            Fair exchange rates
          </li>
          <li className="font-openSans font-normal text-black text-base flex gap-1.5 items-center">
            <GiCheckMark className="text-lg text-[#5CB85C]" />
          ...
          <li className="font-openSans font-normal text-black text-base flex gap-1.5 items-center">
            <GiCheckMark className="text-lg text-[#5CB85C]" /> No hidden charges
          </li>
        </ul>
      </div>
      ...
      <div className="bg-[#F9FBFE] py-6 lg:py-10">
        <div className="flex flex-col lg:flex-row layout-container gap-4 lg:gap-20 justify-between items-center">
          <div className="lg:basis-[60%] order-2  lg:order-1">
            ...
            <p className="font-openSans font-normal text-dark text-base lg:text-xl lg:leading-[150%] mt-4 mb-10">
      ...
      <div className="pt-0 lg:pt-16 pb-10 lg:pb-32 bg-white w-full rounded-es-[50px] rounded-ee-[50px]  overflow-hidden relative -bottom-14">
        <div className="layout-container flex flex-col lg:flex-row lg:justify-between gap-10 lg:gap-20 lg:items-center">
          <div>
            <h2 className="text-3xl lg:text-[56px] font-openSans font-bold text-dark leading-[130%]">
              Where We’re Based
            </h2>
            <p className="font-openSans font-normal text-dark text-base lg:text-xl leading-[180%] mt-6 mb-6 w-[80%]">
              Headquartered in Canada Serving the Indian community across the
              country.
            </p>
            <Button lable="Send Money Now" />
          </div>
          ...
          <div>
            ...
            <div className="bg-white border border-[#E9E9E9] shadow-[0px_6px_20px_0px_#0000000A] p-4 lg:p-8 rounded-[20px]">
              <div className="flex flex-col xl:flex-row gap-3 xl:gap-0  xl:items-center lg:justify-between">
                <div className="flex items-center gap-3.5">
                  ...
                  <span className="font-openSans font-normal text-dark text-base lg:text-lg">
              ...
              <p className="font-openSans font-normal text-dark text-=sm lg:text-lg leading-[150%] mt-8">
